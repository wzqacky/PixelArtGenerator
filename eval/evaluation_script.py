...
class Config:
    ...
    BASELINE_FOLDER = "./baseline_images"  # Images generated by Stable Diffusion Baseline
    FINETUNED_FOLDER = "./finetuned_images"  # Images generated by your finetuned model
    ...
    # Model configuration
    AESTHETIC_MODEL_NAME = "laion/CLIP-ViT-B-32-laion2B-s34B-b79K-aesthetic"  # Aesthetic evaluation model
