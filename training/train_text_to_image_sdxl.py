...
# Adapted from https://github.com/huggingface/diffusers/blob/main/examples/text_to_image/train_text_to_image_sdxl.py
...
def main(args):
    ...
    with accelerator.main_process_first():
        ...
        precomputed_dataset = concatenate_datasets(
            [train_dataset_with_embeddings, train_dataset_with_vae.remove_columns([image_column, caption_column])], axis=1
        )
